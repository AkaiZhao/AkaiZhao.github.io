var fes_data = [
  {
    ...
    date: '12/31~1/1',
    intro:
      '新年初詣依照時間分成三種型式分別是除夜詣、二年參り及初詣。\n除夜詣在大晦日晚上置元旦零時前參拜，會敲響108次除夜鐘，迎來新年。\n二年參り 在除夜詣後返家隔天再次正式參拜稱為二年參り。\n初詣 元旦過後的第一次新年參拜。',
    img_src: 'img/02_fes/fes_1.jpg'
  },
  {
    name: '上野櫻花祭',
    date: '視實際開花情形而定',
    intro:
      '上野恩賜公園裡的櫻花街道，是日本人熟悉的地方。在櫻花祭期間，晦懸掛著1000座燭燈，醞釀初夜櫻宴會的氣氛，一天觀光人數可達10萬人。不妨前來沉醉於800株染井吉野的嬌豔當中吧。',
    img_src: 'img/02_fes/fes_2.jpg'
  },
  {
    name: '淺草三社祭',
    date: '5月第三週的週五、六、日',
    intro:
      '到東京自由行絕對不會錯過淺草神社，如果時間剛好對上絕對要來三社祭的現場朝聖一番，祭典其中不分晝夜都熱鬧非凡，看點有無行文化財產的編木舞，身穿傳統服飾，手持竹片樂器，祈禱著豐收繁盛，還有近100座神轎的聯合遶境，千萬別錯過這個感受夏丁風情與江戶男兒之力的機會!',
    img_src: 'img/02_fes/fes_3.jpg'
  },
  {
    name: '東京隅田川花火大會',
    date: '7月的最後一個周六',
    intro:
      '隅田川花火大會一直都是大家最引頸期盼的夏日花火之一，初次舉辦是為了悼念1732年死於大飢荒及霍亂的亡靈，而從1978年開始隅田川花火大會廣為人知，隅田川花火大會是最具悠久歷史，並最能展現江戶風情的花火大會，每年都有新潮創意的煙火較勁熱鬧非凡。',
    img_src: 'img/02_fes/fes_4.jpg'
  },
  {
    name: '明治神宮秋之大祭',
    date: '11/1~11/3',
    intro:
      '11月3日為明治天皇的冥誕，因此明治神宮從11月1日起便會舉行為期三天的慶祝活動。在這段日期內，明治神宮的境內將會舉行舞樂及流鏑馬競技等祝賀活動。除此之外，日本全國的特產物及花卉等也會在這段時間展示出來。微涼的初秋和家人朋友來到東京旅遊時，不妨來到明治神宮同慶一番。',
    img_src: 'img/02_fes/fes_5.jpg'
  }
];
...
var ramen_data = [
  {
    name: '池袋',
    intro:
      '從JR池袋站徒步即可抵達的範圍內，遍及東池袋至西池袋的廣大範圍內，顧客大排長龍的熱門拉麵店不勝枚舉。',
  ...
  },
  {
    name: '東京',
    intro:
      '東京拉麵街內著名拉麵店家齊聚一堂。打出「即使連吃一週也不膩」的概念，餐點選擇多樣及口味林林總總，讓您百吃不厭。',
  ...
  },
  {
    name: '新宿',
    intro:
      '餐飲店數量規模號稱日本第一的繁華商區的新宿，從JR新宿站的西口前往JR大久保站的小瀧橋通，許多熱門拉麵店比鄰而立。',
...
var trad_data = [
  {
    ...
    img_swiper_1: 'img/06_trad_cuisine/sushi1.jpg',
  ...
  {
    intro:
      '蕎麥麵是江戶時代中期日常生活隨處可見的食物，也是代表江戶味道的食物之一。很少有食物像蕎麥麵品嚐時可以發出聲音。據說這是因為連同空氣一起吸入更能夠享受到蕎麥的香味。',
  ...
  {
    intro:
      '以麵粉打底的麵糊上，放上高麗菜等自己喜歡的餡料，然後舖在鐵板上煎烤而成。在東京文字燒街可在此品嚐到魚貝類及具民族特色等口味多樣的文字燒。',
...
var swiper = new Swiper('#history1', {
  loop: true,
  autoplay: {
    delay: 5000
  },
...
var swiper = new Swiper('#history2', {
  loop: true,
  autoplay: {
    delay: 5000
  }
});
var trad_swiper = new Swiper('.trad', {
  loop: true,
  // simulateTouch: false,
  autoplay: {
    delay: 20000
...
$('.nav_phone').on('click', function() {
  $('.nav_phone').toggleClass('height_full');
  $('.nav .bar').toggleClass('click_color');
  $('.nav .bar1').toggleClass('click');
  $('.nav .bar2').toggleClass('click');
  $('.nav .bar3').toggleClass('click');
});
